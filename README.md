...
- **Important:** Stylish is now charging a subscription to access their extension. Since this style works best with Stylish, you can download an old copy of the extension without the paywall [here.](https://drive.google.com/drive/folders/11c4Wp2tAwaZsntYzZk4eq0IjKakT-an8?usp=sharing) In Chrome or Edge, uninstall the existing extension. Type chrome://extensions into the address bar. Enable developer mode and click **Load unpacked.** Choose the folder you downloaded that has the version number, and enjoy!
